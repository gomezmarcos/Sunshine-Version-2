...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int deleteId;
        switch (match) {
            case WeatherProvider.WEATHER: {
                deleteId = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            }
            case WeatherProvider.LOCATION: {
                deleteId = db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            }
            default:
        ...
        if (deleteId!=0 && selectionArgs[0]!=null)
            getContext().getContentResolver().notifyChange(uri,null);
