...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        testValues.put(LocationEntry.COLUMN_LOCATION_SETTING, 1824);
        testValues.put(LocationEntry.COLUMN_CITY_NAME, "North Pole");
        testValues.put(LocationEntry.COLUMN_COORD_LAT, 64.7488);
        testValues.put(LocationEntry.COLUMN_COORD_LONG, -147.353);

        // Insert ContentValues into database and get a row ID back
        String lastRowId = String.valueOf(db.insert(LocationEntry.TABLE_NAME, null, testValues));

        // Query the database and receive a Cursor back
        Cursor cursor = db.query(false, LocationEntry.TABLE_NAME, new String[]{LocationEntry.COLUMN_CITY_NAME}, LocationEntry._ID.toString() + "=?", new String[]{lastRowId}, null, null, null, null);
        ...
        for (int i = 0; i < columnNames.length; i++){
            if (columnNames[i].equals(LocationEntry.COLUMN_CITY_NAME))
                result = i;
        }
        String cityName = cursor.getString(result);
        assertEquals("Son iguales el de la base que este?","North Pole", cityName);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long lastWeatherId = db.insert(WeatherEntry.TABLE_NAME, null, weatherValues);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        assertEquals("Son iguales los ids?", new Float(1.1), cursor.getFloat(10));
    ...
    public long insertLocation() {
        ...
        // Finally, close the cursor and database
        cursor.close();
        return Integer.parseInt(lastRowId);
    }
}
